 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `seraphiel_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Seraphiel Teal",
  description: "Classic dark teal — the canonical Seraphiel look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Seraphiel look, ported from the
 ...
 * nousnet-web's <body> is white; seraphiel-brain's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Seraphiel Teal (Large)",
  description: "Seraphiel Teal with bigger fonts and roomier spacing",
