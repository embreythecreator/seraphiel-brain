...
const STORAGE_KEY = "seraphiel-dashboard-theme";
...
const FONT_STORAGE_KEY = "seraphiel-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `seraphiel_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "seraphiel-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-seraphiel-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-seraphiel-theme-font", "true");
