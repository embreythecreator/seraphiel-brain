 ...
 * `window.__SERAPHIEL_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Seraphiel brand in the top bar
 ...
 *  `window.__SERAPHIEL_PLUGINS__.registerSlot(...)`.
 *
