 ...
 *
 * Plugins call window.__SERAPHIEL_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__SERAPHIEL_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SERAPHIEL_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SERAPHIEL_PLUGIN_SDK__ = {
    ...
    // window.__SERAPHIEL_SESSION_TOKEN__ directly.
    authedFetch,
