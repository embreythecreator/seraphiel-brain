/**
 * Seraphiel Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__SERAPHIEL_PLUGIN_SDK__`` and
 * ``window.__SERAPHIEL_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__SERAPHIEL_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``SeraphielPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@seraphiel/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__SERAPHIEL_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__SERAPHIEL_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__SERAPHIEL_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface SeraphielPluginSDK {
...
declare global {
  interface Window {
    __SERAPHIEL_PLUGIN_SDK__?: SeraphielPluginSDK;
    __SERAPHIEL_PLUGINS__?: PluginRegistry;
  }
}
