...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateSeraphiel: string;
    updateSeraphielConfirmMessage?: string;
    updateSeraphielConfirmNow?: string;
    updateSeraphielConfirmTitle?: string;
    updatingSeraphiel: string;
  ...
  // ── Achievements plugin (plugins/seraphiel-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
