 ...
 *
 * Values mirror seraphiel_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Seraphiel default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Seraphiel' default when unset). */
