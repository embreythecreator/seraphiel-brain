...
DEFAULT_DATASETS = [
    "embreythecreator/swe-terminus-agent-glm-kimi-minimax",
    "embreythecreator/seraphiel-brain-megascience-sft1",
    "embreythecreator/seraphiel-Agent-Thinking-GLM-4.7-SFT2",
    "embreythecreator/seraphiel-Agent-Thinking-GLM-4.7-SFT1",
    "embreythecreator/terminal-tasks-glm-seraphiel-brain"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "embreythecreator/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload embreythecreator/{output_name} {final_output}")
