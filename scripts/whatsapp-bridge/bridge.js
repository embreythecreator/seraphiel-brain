...
const IMAGE_CACHE_DIR = path.join(process.env.HOME || '~', '.seraphiel', 'image_cache');
const DOCUMENT_CACHE_DIR = path.join(process.env.HOME || '~', '.seraphiel', 'document_cache');
const AUDIO_CACHE_DIR = path.join(process.env.HOME || '~', '.seraphiel', 'audio_cache');
