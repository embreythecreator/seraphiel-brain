#!/usr/bin/env python3
"""Build the Seraphiel Model Catalog — a centralized JSON manifest of curated models.
...
Seraphiel CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Seraphiel release.
...
# Ensure SERAPHIEL_HOME is set for imports that touch it at module level.
os.environ.setdefault("SERAPHIEL_HOME", os.path.join(os.path.expanduser("~"), ".seraphiel"))

from seraphiel_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "seraphiel-brain repo",
            "docs": "https://seraphiel-brain.embreythecreator.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Seraphiel '
