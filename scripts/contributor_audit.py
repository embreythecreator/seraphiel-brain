...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Seraphiel\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@embreythecreator.com",
    "cursoragent@cursor.com",
    "seraphiel@embreythecreator.com",
    "seraphiel-audit@example.com",
    "nousbot@embreythecreator.com",
    "seraphiel@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "embreythecreator/seraphiel-brain",
                "--state", "merged",
