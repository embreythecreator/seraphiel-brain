#!/usr/bin/env python3
"""Build the Seraphiel Skills Index — a centralized JSON catalog of all skills.
...
`seraphiel skills search/install` can use it without hitting the GitHub API.
...
# Ensure SERAPHIEL_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Seraphiel Skills Index...", flush=True)
