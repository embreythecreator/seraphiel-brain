...
def _profile_user_agent() -> str:
    """Return a ``seraphiel-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from seraphiel_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"seraphiel-cli/{_ver}"
    except Exception:
        return "seraphiel-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # seraphiel-cli UA so the catalog endpoint is reachable.
