...
def _default_registry_path() -> Path:
    return get_seraphiel_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_seraphiel_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_seraphiel_home = expected_seraphiel_home if expected_seraphiel_home is not None else str(get_seraphiel_home())
    ...
    def _spawn_locked(self, *, reason: str) -> None:
        ...
        if self.env:
            env.update(self.env)
        env["SERAPHIEL_COMPUTE_HOST_HEARTBEAT_SECS"] = str(self.heartbeat_secs)
    ...
    def _validate_hello(self) -> None:
        ...
        got_home = str(hello.get("seraphiel_home") or "")
        if got_home and got_home != self.expected_seraphiel_home:
            raise RuntimeError(f"compute host SERAPHIEL_HOME mismatch: {got_home} != {self.expected_seraphiel_home}")
