#!/usr/bin/env python3
"""
SWE Runner with Seraphiel Trajectory Format

A runner that uses Seraphiel Brain's built-in execution environments
(local, docker, modal) and outputs trajectories in the Seraphiel Brain format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Seraphiel Brain's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Seraphiel format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Seraphiel Brain format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Seraphiel Brain's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Seraphiel Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Seraphiel Brain's built-in execution environments
    and outputs trajectories in Seraphiel Brain format.
    """
    ...
    def _convert_to_seraphiel_format(
        self,
        ...
        """
        Convert internal message format to Seraphiel trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Seraphiel trajectory format
        trajectory = self._convert_to_seraphiel_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Seraphiel trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Seraphiel Trajectory Format")
    print("=" * 60)
