...
在环境中设置 Tenor API 密钥（添加到 `~/.seraphiel/.env`）：
...
- GIF URL 可直接用于 markdown：`![alt](https://github.com/embreythecreator/seraphiel-brain/blob/main/skills/media/gif-search/url)`