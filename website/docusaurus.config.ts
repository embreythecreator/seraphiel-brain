...
const config: Config = {
  ...
  url: 'https://seraphiel-brain.embreythecreator.com',
  baseUrl: '/docs/',

  organizationName: 'embreythecreator',
  projectName: 'seraphiel-brain',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-seraphiel-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/embreythecreator/seraphiel-brain/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/seraphiel-brain-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/embreythecreator/seraphiel-brain',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/embreythecreator/seraphiel-brain/issues' },
