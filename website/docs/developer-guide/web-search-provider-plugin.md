...
| `requires_env` | Interactive credential prompt during `seraphiel plugins install` (see [Build a Seraphiel Plugin](/developer-guide/plugins#gate-on-environment-variables) for the rich format) |
