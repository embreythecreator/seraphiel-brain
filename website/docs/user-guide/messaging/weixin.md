...
| Terminal QR code doesn't render | Reinstall with the messaging extra: `pip install seraphiel-brain[messaging]`. Alternatively, open the URL printed above the QR |
