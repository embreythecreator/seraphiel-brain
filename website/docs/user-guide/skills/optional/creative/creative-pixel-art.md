...
| | |
|---|---|
| Source | Optional — install with `seraphiel skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.seraphiel/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.seraphiel/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Seraphiel installs package this)
