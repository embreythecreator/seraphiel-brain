...
| | |
|---|---|
| Source | Optional — install with `seraphiel skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Seraphiel Brain |
| License | MIT |
...
```
SCRIPT=~/.seraphiel/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.seraphiel/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
