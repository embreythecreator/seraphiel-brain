...
| | |
|---|---|
| Source | Optional — install with `seraphiel skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Seraphiel Brain |
| License | MIT |
...
import upstream classes into Seraphiel itself.
...
Open `~/.seraphiel/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Seraphiel core.
   Custom driver scripts under `~/.seraphiel/skills/...` are user-side and fine.
