...
| | |
|---|---|
| Source | Optional — install with `seraphiel skills install official/research/qmd` |
...
Seraphiel Brain via the native MCP client. This is the preferred
...
Then configure Seraphiel Brain to connect via HTTP:
