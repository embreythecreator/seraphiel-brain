...
| | |
|---|---|
| Source | Optional — install with `seraphiel skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Seraphiel Brain |
| License | MIT |
...
The script reads `${SERAPHIEL_HOME:-~/.seraphiel}/.env` for two optional defaults:
...
Helper script: `~/.seraphiel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.seraphiel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${SERAPHIEL_HOME:-~/.seraphiel}/.env`.
...
```bash
python3 ~/.seraphiel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.seraphiel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
