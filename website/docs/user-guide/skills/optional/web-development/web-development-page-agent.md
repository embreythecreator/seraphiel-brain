...
- User wants **Seraphiel itself to drive a browser** → use Seraphiel' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
