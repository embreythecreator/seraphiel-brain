...
| | |
|---|---|
| Source | Optional — install with `seraphiel skills install official/health/neuroskill-bci` |
...
Connect Seraphiel to a running [NeuroSkill](https://neuroskill.com/) instance to read
