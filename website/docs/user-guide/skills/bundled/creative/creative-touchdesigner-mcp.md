...
| Related skills | [`native-mcp`](/docs/user-guide/skills/bundled/mcp/mcp-native-mcp), [`ascii-video`](/docs/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](/docs/user-guide/skills/bundled/creative/creative-manim-video), `seraphiel-video` |
...
3. Add `twozero_td` MCP server to Seraphiel config (if missing)
...
3. **Restart Seraphiel session** to pick up the new MCP server
