...
**Switching modes:** Re-run `seraphiel memory setup mem0 --mode <platform|oss>` or edit `mem0.json` directly.
...
| **Requires** | `pip install supermemory` + [API key](http://app.supermemory.ai/integrations?connect=seraphiel) |
