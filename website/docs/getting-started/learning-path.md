...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Seraphiel Brain documentation based on your experience level and goals.'
---

# Learning Path

Seraphiel Brain can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Seraphiel Brain yet, begin with the [Installation guide](/getting-started/installation) and then run through the [Quickstart](/getting-started/quickstart). Everything below assumes you have a working installation.
:::

:::tip First-time provider setup
First-time users almost always want `seraphiel setup --portal` — one OAuth covers a model plus the four Tool Gateway tools (search/image/TTS/browser). See [Nous Portal](/integrations/nous-portal).
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Seraphiel Brain can do.
...
Use Seraphiel Brain as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Seraphiel Brain can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Seraphiel Brain as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with Seraphiel](/guides/use-voice-mode-with-seraphiel)
...
:::tip
Cron jobs let Seraphiel Brain run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::
...
page is for built-in Seraphiel core development, not the usual user/custom-tool path.
:::

### "I want to train models"

Use reinforcement learning to fine-tune model behavior with Seraphiel Brain's RL training pipeline (powered by [Atropos](https://github.com/embreythecreator/atropos)).

1. [Quickstart](/getting-started/quickstart)
2. [Configuration](/user-guide/configuration)
3. [Atropos RL Environments](https://github.com/embreythecreator/atropos) (external)
4. [Provider Routing](/user-guide/features/provider-routing)
5. [Architecture](/developer-guide/architecture)

:::tip
RL training works best when you already understand the basics of how Seraphiel Brain handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Seraphiel Brain into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call Seraphiel tools programmatically | [Code Execution](/user-guide/features/code-execution) |
