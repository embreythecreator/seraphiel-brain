...
For how to ship skills in your own plugin, see [Build a Seraphiel Plugin → Bundle skills](/developer-guide/plugins#bundle-skills).
...
seraphiel config get skills.config --json
```
