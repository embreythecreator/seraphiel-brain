---
sidebar_position: 8
title: "Use Voice Mode with Seraphiel"
description: "A practical guide to setting up and using Seraphiel voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Seraphiel
...
- you want Seraphiel sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Seraphiel.
...
## Step 1: make sure normal Seraphiel works first
...
Seraphiel supports both local and cloud speech stacks.
...
4. Seraphiel transcribes and responds
...
- asking Seraphiel to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Seraphiel loop.

## Tuning CLI behavior

### Silence threshold

If Seraphiel starts/stops too aggressively, tune:
...
Seraphiel stays a normal chat bot, but can speak replies.
...
- you want Seraphiel to function like a portable research or ops assistant
...
Seraphiel joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Seraphiel detects speech boundaries
- transcripts are posted in the associated text channel
- Seraphiel responds in text and audio
...
1. get text Seraphiel working
2. install `seraphiel-brain[voice]`
