...
slug: /
sidebar_position: 0
title: "Seraphiel Brain Documentation"
description: "The self-improving AI agent built by Seraphiel. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Seraphiel](https://embreythecreator.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `seraphiel setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Seraphiel Brain?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Seraphiel safely  |
| 🧭 **[Use MCP with Seraphiel](/guides/use-mcp-with-seraphiel)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Seraphiel](/guides/use-voice-mode-with-seraphiel)** | Hands-on setup and usage patterns for Seraphiel voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Seraphiel' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Seraphiel                              |
...
- **Built by model trainers** — Created by [Seraphiel](https://embreythecreator.com), the lab behind Seraphiel, Nomos, and Psyche. Works with [Nous Portal](https://portal.embreythecreator.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Seraphiel](https://embreythecreator.com) — the lab behind Seraphiel, Nomos, and Psyche models
