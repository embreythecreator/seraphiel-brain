...
- **[AI Providers](/integrations/providers)** — OpenRouter, Anthropic, OpenAI, Google, and any OpenAI-compatible endpoint. Seraphiel auto-detects capabilities like vision, streaming, and tool use per provider.
...
- **[Build a Plugin](/developer-guide/plugins)** — Step-by-step guide for creating Seraphiel plugins with tools, hooks, and CLI commands.
