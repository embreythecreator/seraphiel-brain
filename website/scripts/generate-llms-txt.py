#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Seraphiel docs site.
...
Both publish at:
  https://seraphiel-brain.embreythecreator.com/docs/llms.txt
  https://seraphiel-brain.embreythecreator.com/docs/llms-full.txt
...
SITE_BASE = "https://seraphiel-brain.embreythecreator.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Seraphiel as a Python Library", None),
        ("guides/use-mcp-with-seraphiel", "Use MCP with Seraphiel", None),
        ("guides/use-voice-mode-with-seraphiel", "Use Voice Mode with Seraphiel", None),
        ("guides/use-soul-with-seraphiel", "Use SOUL.md with Seraphiel", None),
        ("guides/build-a-seraphiel-plugin", "Build a Seraphiel Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Seraphiel"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Seraphiel Brain")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Seraphiel. A terminal-native "
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/embreythecreator/"
        "seraphiel-brain/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/embreythecreator/seraphiel-brain")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Seraphiel Brain — Full Documentation\n",
        (
            "This file is the entire Seraphiel Brain documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Seraphiel, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://seraphiel-brain.embreythecreator.com/docs\n",
        "Short index: https://seraphiel-brain.embreythecreator.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
