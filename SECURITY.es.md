# Política de Seguridad de Seraphiel Brain

Este documento describe el modelo de confianza de Seraphiel Brain, identifica el
...
Reporta de forma privada a través de [GitHub Security Advisories](https://github.com/embreythecreator/seraphiel-brain/security/advisories/new)
o **security@embreythecreator.com**. No abras issues públicos para
vulnerabilidades de seguridad. **Seraphiel Brain no opera un programa de
...
- Detalles del entorno (`seraphiel version`, SHA del commit, SO, versión de Python).
...
Seraphiel Brain es un agente personal de un solo inquilino. Su postura es
...
- **Proceso del agente.** El intérprete Python que ejecuta Seraphiel Brain,
...
- **Envolvente de confianza.** El conjunto de recursos a los que un operador ha otorgado
  implícitamente acceso a Seraphiel Brain al ejecutarlo — típicamente, todo lo que
  la propia cuenta de usuario del operador puede alcanzar en el host.
- **Postura.** Una declaración explícita en la documentación o código de Seraphiel Brain
...
Seraphiel Brain admite dos posturas de aislamiento a nivel de SO. Abordan
...
Seraphiel Brain admite esto de dos maneras:

- **La propia imagen Docker de Seraphiel Brain y la configuración de Compose.** Más
...
Bajo una envoltura de proceso completo, las heurísticas en proceso de Seraphiel Brain
...
Seraphiel Brain filtra el entorno que pasa a sus componentes en proceso de
...
Un plugin malicioso o con errores no es una vulnerabilidad en Seraphiel Brain
en sí mismo. Los errores en la ruta de instalación o descubrimiento de plugins de Seraphiel Brain
...
**Superficies en Seraphiel Brain:**
...
4. **Dentro del conjunto autorizado, todos los llamadores tienen la misma confianza.**
   Seraphiel Brain no modela capacidades por llamador dentro de un único adaptador.
...
- Violaciones de la documentación del modelo de confianza: código que se comporta
  contrariamente a lo que esta política, la propia documentación de Seraphiel Brain o
  las expectativas razonables del operador predecirían — incluyendo casos donde
  Seraphiel Brain ha documentado una postura sobre cómo su salida debe ser
...
- **Configuraciones documentadas de emergencia.** Compensaciones seleccionadas por el operador
  ...
  la seguridad de seraphiel-home, y similares. Los informes contra esas
...
- **Habilidades y plugins contribuidos por la comunidad.** Las habilidades de terceros
  ...
  están en la superficie de revisión del operador, no en la superficie de confianza de Seraphiel Brain
  (§2.4, §2.5). Una habilidad o plugin que haga algo
  malicioso es el modo de falla esperado de uno que no fue
  revisado, no una vulnerabilidad en Seraphiel Brain. Los errores en la ruta de
  instalación de habilidades o plugins de Seraphiel Brain que impidan al
...
- Seraphiel Brain incluye guardias de cadena de suministro para lanzamientos de servidores
