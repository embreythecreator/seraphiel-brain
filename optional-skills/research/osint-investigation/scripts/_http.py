...
DEFAULT_UA = (
    "seraphiel-osint-investigation/0.2 "
    "(+https://github.com/embreythecreator/seraphiel-brain; "
    "set SERAPHIEL_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("SERAPHIEL_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
