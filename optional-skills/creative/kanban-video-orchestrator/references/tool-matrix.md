...
Maps each role archetype to the Seraphiel skills it should `always_load` and the
toolsets it needs. Only references skills that ship in the public seraphiel-brain
...
## Seraphiel skills relevant to video production

### Visual / rendering skills (`seraphiel-brain/skills/creative/`)
...
### Design / pre-production skills (`seraphiel-brain/skills/creative/`)
...
### Audio / media skills (`seraphiel-brain/skills/creative/` + `skills/media/`)
...
### Kanban infrastructure (`seraphiel-brain/skills/devops/`)
...
These are **not** Seraphiel skills but external CLIs / APIs that profiles invoke.
...
## Built-in Seraphiel tools for media review

These are native Seraphiel tools — not invoked via terminal but through their own
...
When a new Seraphiel-public video skill ships:
