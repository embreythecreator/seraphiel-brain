...
metadata:
  seraphiel:
    ...
    credits: |
      ...
      https://github.com/embreythecreator/kanban-video-pipeline.
---
...
6. **The director never executes.** Even with the full `kanban + terminal +
   ...
   a `seraphiel kanban create` call to a specialist profile. The kanban
