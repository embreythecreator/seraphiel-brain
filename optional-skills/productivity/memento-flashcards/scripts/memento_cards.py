...
Data file: $SERAPHIEL_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SERAPHIEL_HOME = Path(os.environ.get("SERAPHIEL_HOME", Path.home() / ".seraphiel"))
DATA_DIR = _SERAPHIEL_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
