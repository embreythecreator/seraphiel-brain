...
When running Seraphiel inside Docker, the default `network_mode: host` gives the
...
The Seraphiel [SECURITY.md](../../SECURITY.md) §2 defines the trust model. The
...
│                                             │
│   ┌──────────────┐   ┌──────────────────┐   │
│   │ seraphiel-brain │   │ seraphiel-dashboard │   │
│   └──────┬───────┘   └────────┬─────────┘   │
│          │                    │              │
│          ▼                    │              │
│   ┌──────────────┐            │              │
...
#
# Usage:
#   SERAPHIEL_UID=$(id -u) SERAPHIEL_GID=$(id -g) docker compose up -d
#
...
services:
  gateway:
    ...
    environment:
      ...
      - NO_PROXY=seraphiel,seraphiel-dashboard,localhost
...
docker compose exec gateway \
  curl -sf --max-time 5 http://seraphiel-dashboard:9119/health && echo "OK: internal reachable" || echo "FAIL"
...
- [SECURITY.md](../../SECURITY.md) — Seraphiel trust model and vulnerability reporting
