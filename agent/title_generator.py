...
def _auto_title_enabled() -> bool:
    ...
    try:
        ...
        # from agent code paths where a module-level seraphiel_cli import risks
...
def auto_title_session(
    ...
    post-``seraphiel update`` stale-module window, where this function's lazy
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running Seraphiel process): %s",
            e,
        )
