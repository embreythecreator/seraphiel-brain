...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``seraphiel logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Seraphiel only initiates compaction in "seraphiel" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Seraphiel preflight compression for codex app-server "
                "(mode=%s); Seraphiel will not start thread compaction here.",
