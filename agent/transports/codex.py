...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # through Seraphiel's agent loop.
        #
        ...
        # that would silently route around Seraphiel's web-provider config and
        ...
        # native search engine for xAI sessions instead of Seraphiel's
        # configured web provider (Tavily/etc.), and those results bypass
        # Seraphiel's tool-trace / citation plumbing (they arrive baked into the
