...
PLATFORM_HINTS = {
    ...
    "desktop": (
        "You are chatting inside the Seraphiel desktop app — a graphical chat "
...
def _current_session_platform_hint() -> str:
    ...
    platform = os.environ.get("SERAPHIEL_PLATFORM") or os.environ.get("SERAPHIEL_SESSION_PLATFORM")
    if platform:
        return platform
...
def build_context_files_prompt(
    ...
    # Never let a FALLBACK-picked directory inside the Seraphiel install/source
    ...
    # explicitly configured cwd is honored verbatim — the Seraphiel tree is a
    ...
    # their launch dir IS the user's shell cwd (developing Seraphiel in-tree).
    ...
    if (
        ...
        logger.warning(
            ...
            "fell back to the Seraphiel install tree (%s) — set terminal.cwd to "
