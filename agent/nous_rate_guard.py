...
(3 SDK retries x 3 Seraphiel retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_seraphiel_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".seraphiel")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Seraphiel, ...) behind one endpoint.  A 429 can mean either:
