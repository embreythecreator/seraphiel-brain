"""Vertex AI (Google Cloud) adapter for Seraphiel Brain.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Seraphiel to use Gemini models via Google Cloud with
...
# who installed plain `seraphiel-brain` and only later selected a Gemini model.
try:
