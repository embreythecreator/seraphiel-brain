...
When a provider returns a non-OK status on a *streaming* request, Seraphiel reads
...
streams"), generalized to cover Seraphiel's three streaming error-body sites
