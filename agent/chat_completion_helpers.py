...
def interruptible_api_call(agent, api_kwargs: dict):
    ...
    if _ttfb_timeout <= 0:
        ...
        _ttfb_disable_above = _env_float("SERAPHIEL_CODEX_TTFB_DISABLE_ABOVE_TOKENS", 25_000.0)
        ...
        if (
            ...
            logger.info(
                ...
                "Set SERAPHIEL_CODEX_TTFB_STRICT=1 to force early reconnects.",
...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    # the user explicitly set SERAPHIEL_STREAM_STALE_TIMEOUT.
