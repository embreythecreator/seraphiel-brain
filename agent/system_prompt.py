...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    if active_profile == "default":
        stable_parts.append(
            ...
            "under ~/.seraphiel/profiles/<name>/. Each profile has its own "
        ...
        stable_parts.append(
            ...
            f"and writes ~/.seraphiel/profiles/{active_profile}/. The default "
            f"profile's data lives at ~/.seraphiel/skills/, ~/.seraphiel/plugins/, "
            f"~/.seraphiel/cron/, ~/.seraphiel/memories/ — those belong to a "
