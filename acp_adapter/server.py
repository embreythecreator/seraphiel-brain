...
class SeraphielACPAgent(acp.Agent):
    ...
    async def prompt(
        ...
        **kwargs: Any,
        ...
        # not the executor's. Also set SERAPHIEL_INTERACTIVE so approval.py
        ...
        def _run_agent() -> dict:
            ...
            previous_interactive = os.environ.get("SERAPHIEL_INTERACTIVE")
            ...
            try:
                ...
                # Restore SERAPHIEL_INTERACTIVE.
                if previous_interactive is None:
                    os.environ.pop("SERAPHIEL_INTERACTIVE", None)
                else:
                    os.environ["SERAPHIEL_INTERACTIVE"] = previous_interactive
