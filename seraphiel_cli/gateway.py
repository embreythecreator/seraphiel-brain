...
def _scan_gateway_pids(exclude_pids: set[int], all_profiles: bool = False) -> list[int]:
    ...
    patterns = [
        ...
        "seraphiel_cli.main --profile",
        "seraphiel_cli.main -p",
        "seraphiel_cli/main.py gateway",
        "seraphiel_cli/main.py --profile",
        "seraphiel_cli/main.py -p",
        "seraphiel gateway",
        ...
        # ``seraphiel.exe --profile`` / ``seraphiel.exe -p`` would also match
        # ``seraphiel.exe --profile foo dashboard`` and other CLI subcommands,
        # producing false-positive gateway PIDs (Copilot review).
        "seraphiel.exe gateway",
        "seraphiel-gateway.exe",
        "gateway/run.py",
    ]
...
def _profile_arg(seraphiel_home: str | None = None) -> str:
