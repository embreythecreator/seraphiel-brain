...
Used by ``seraphiel profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``seraphiel_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Seraphiel Brain kanban board.
...
Rules:
  ...
  - Never write "Seraphiel Brain profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_seraphiel_home())
        else:
