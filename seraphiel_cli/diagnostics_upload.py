"""Client for uploading ``seraphiel debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``seraphiel debug share``.
...
NAS_BASE = os.environ.get(
    "SERAPHIEL_DIAGNOSTICS_BASE_URL", "https://portal.embreythecreator.com"
)
...
_USER_AGENT = "seraphiel-brain/debug-share"
