...
Usage:
    seraphiel pairing list              # Show all pending + approved users
    seraphiel pairing approve <platform> <code>  # Approve a pairing code
    seraphiel pairing revoke <platform> <user_id> # Revoke user access
    seraphiel pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle seraphiel pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: seraphiel pairing {list|approve|revoke|clear-pending}")
        print("Run 'seraphiel pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.seraphiel/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'seraphiel pairing list' to see pending codes.\n")
