"""
Seraphiel CLI - Unified command-line interface for Seraphiel Brain.

Provides subcommands for:
- seraphiel chat          - Interactive chat (same as ./seraphiel)
- seraphiel gateway       - Run gateway in foreground
- seraphiel gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `seraphiel setup` on a fresh Pi.
    ...
    seraphiel_cli/stdio.py::configure_windows_stdio() runs later from the entry
