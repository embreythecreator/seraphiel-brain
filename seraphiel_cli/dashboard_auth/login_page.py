...
Visual styling mirrors the Seraphiel design system (the
...
``tests/seraphiel_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Seraphiel Brain</title>
<style>
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Seraphiel Brain dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Seraphiel Brain</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
