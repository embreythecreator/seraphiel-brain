...
# integration credentials follow that prefix (SERAPHIEL_GEMINI_CLIENT_ID,
# SERAPHIEL_LANGFUSE_PUBLIC_KEY, SERAPHIEL_SPOTIFY_CLIENT_ID, ...). The
...
from seraphiel_cli.default_soul import DEFAULT_SOUL_MD
...
def _ensure_default_soul_md(home: Path) -> None:
    """Seed a default SOUL.md into SERAPHIEL_HOME if the user doesn't have one yet."""
...
DEFAULT_CONFIG = {
    ...
    "updates": {
        ...
        # can be restored with ``seraphiel import <path>``.  Defaults to true
        # after the #48200 incident: a ``seraphiel update --yes`` run that
...
OPTIONAL_ENV_VARS = {
    ...
    "SERAPHIEL_GEMINI_CLIENT_SECRET": {
