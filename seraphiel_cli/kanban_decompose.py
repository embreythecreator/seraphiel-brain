...
Invoked by ``seraphiel kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Seraphiel Brain board.
...
def _profile_author() -> str:
    """Mirror of ``seraphiel_cli.kanban._profile_author``."""
    return (
