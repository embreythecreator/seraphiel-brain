"""``seraphiel cron`` subcommand parser.

Extracted verbatim from ``seraphiel_cli/main.py:main()`` — same arguments, same
...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_create.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.seraphiel/scripts/. Default mode: "
    ...
    cron_create.add_argument(
        "--profile",
        help="Seraphiel profile name to run the job under. Use 'default' for the root profile. Named profiles must already exist. Omit to preserve the scheduler's existing profile.",
    )
    ...
    cron_edit.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.seraphiel/scripts/. Pass empty string to clear. "
    ...
    cron_edit.add_argument(
        "--profile",
        help="Seraphiel profile name to run the job under. Use 'default' for the root profile. Pass empty string to clear.",
    )
