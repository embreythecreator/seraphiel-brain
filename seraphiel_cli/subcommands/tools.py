"""``seraphiel tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'seraphiel tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # seraphiel tools list [--platform cli]
    ...
    # seraphiel tools disable <name...> [--platform cli]
    ...
    # seraphiel tools enable <name...> [--platform cli]
    ...
    # seraphiel tools post-setup <key>
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `seraphiel tools` runs after you pick a provider that\n"
