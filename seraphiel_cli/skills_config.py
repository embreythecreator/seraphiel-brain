"""
Skills configuration for Seraphiel Brain.
`seraphiel skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.seraphiel/config.yaml under:
...
from seraphiel_cli.config import cfg_get, load_config, save_config
from seraphiel_cli.colors import Colors, color
from seraphiel_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `seraphiel skills`."""
    from seraphiel_cli.curses_ui import curses_checklist
