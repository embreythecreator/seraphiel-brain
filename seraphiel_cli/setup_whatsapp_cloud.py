...
Entry point: ``seraphiel whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``seraphiel_cli/main.py``).
...
Seraphiel gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Seraphiel to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Seraphiel needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Seraphiel gateway in another terminal:")
    print("         seraphiel gateway")
    print()
    ...
    print()
    print("  Docs: https://seraphiel-brain.embreythecreator.com/docs/user-guide/")
