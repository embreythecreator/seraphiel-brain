...
def switch_model(
    ...
    # Mirrors the same logic in seraphiel_cli.runtime_provider.resolve_runtime_provider;
    ...
    *,
    ...
    for seraphiel_id, mdev_id in PROVIDER_TO_MODELS_DEV.items():
        ...
        if not has_creds:
            try:
                ...
                if store and store.get("credential_pool", {}).get(seraphiel_id):
                    has_creds = True
            except Exception:
                pass
        if not has_creds:
    ...
    if user_providers and isinstance(user_providers, dict):
        for ep_name, ep_cfg in user_providers.items():
            ...
            # ``base_url`` is Seraphiel's canonical write key (matches
            ...
            # Seraphiel writes ``models:`` as a dict keyed by model id
            # (see seraphiel_cli/main.py::_save_custom_provider); older
    ...
    if custom_providers and isinstance(custom_providers, list):
        ...
        for entry in custom_providers:
            ...
            if group_key not in groups:
                ...
                # Seraphiel's own writer uses; a hyphen variant is accepted
