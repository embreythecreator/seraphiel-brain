...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_seraphiel_brain_browser()
    ),
...
def _has_seraphiel_brain_browser() -> bool:
    ...
    # install.sh installs globally into $SERAPHIEL_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-SeraphielHome", str(get_seraphiel_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = seraphiel_subprocess_env(inherit_credentials=False)
