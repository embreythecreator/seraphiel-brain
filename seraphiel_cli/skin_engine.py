"""Seraphiel CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.seraphiel/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    from seraphiel_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Seraphiel Brain"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.seraphiel/skins/
...
Drop a YAML file in ``~/.seraphiel/skins/<name>.yaml`` following the schema above.
...
def _skins_dir() -> Path:
    ...
    return get_seraphiel_home() / "skins"
