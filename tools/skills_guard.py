...
Trust levels:
  - builtin:   Ships with Seraphiel. Never scanned, always trusted.
...
SKILL_INSTALL_PATTERNS = [
    ...
    (r'\$HOME/\.seraphiel/\.env|\~/\.seraphiel/\.env',
     "seraphiel_env_access", "critical", "exfiltration",
     "directly references Seraphiel secrets file"),
    ...
    (r'\.seraphiel/config\.yaml|\.seraphiel/SOUL\.md',
     "seraphiel_config_mod", "critical", "persistence",
     "references Seraphiel configuration files directly"),
...
# scan. `.skillignore` is the Seraphiel-native name; `.clawhubignore` is honored
