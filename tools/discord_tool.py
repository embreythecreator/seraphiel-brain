...
Only included in the seraphiel-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Seraphiel Brain (https://github.com/embreythecreator/seraphiel-brain)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_seraphiel_home() / "cache" / "discord_capabilities.json"
