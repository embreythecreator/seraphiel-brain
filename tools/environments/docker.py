...
from tools.environments.local import _SERAPHIEL_PROVIDER_ENV_BLOCKLIST
...
class DockerEnvironment(BaseEnvironment):
    ...
    def _build_init_env_args(self) -> list[str]:
        ...
        # keys are filtered.
        forward_keys = explicit_forward_keys | (passthrough_keys - _SERAPHIEL_PROVIDER_ENV_BLOCKLIST)
