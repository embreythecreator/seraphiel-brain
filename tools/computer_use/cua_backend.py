...
can break on OS updates. Pin the installed version via `SERAPHIEL_CUA_DRIVER_
...
PINNED_CUA_DRIVER_VERSION = os.environ.get("SERAPHIEL_CUA_DRIVER_VERSION", "0.5.0")
