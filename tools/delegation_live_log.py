...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.seraphiel)."""
    from seraphiel_constants import get_seraphiel_dir

    return get_seraphiel_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== Seraphiel subagent live transcript ===",
