...
let
  ...
  targetPlatform =
    if stdenv.hostPlatform.isDarwin then
      ...
      throw "seraphiel-desktop: unsupported host platform for node-pty staging";
  ...
  targetArch =
    if stdenv.hostPlatform.isAarch64 then
      ...
      throw "seraphiel-desktop: unsupported host arch for node-pty staging";
...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    substituteInPlace $out/share/seraphiel-desktop/dist/electron-main.mjs \
      --replace-fail "process.resourcesPath" "'$out/share/seraphiel-desktop'"
