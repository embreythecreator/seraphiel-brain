      ...
      let
        ...
        excludedDirs =
          ...
          ++ [
            ...
            "nix"
            # Skills are shipped via SERAPHIEL_BUNDLED_SKILLS /
            # SERAPHIEL_OPTIONAL_SKILLS (see seraphiel-brain.nix), not via the
...
in
{
  ...
  #
  # Usage:
  #   npm = seraphielNpmLib.mkNpmPassthru { dirs = [ "ui-tui" ]; };
  #   npm = seraphielNpmLib.mkNpmPassthru { dirs = [ "apps/desktop" "apps/shared" ]; };
