# Streaming LLM Response Support for Seraphiel Brain
...
```
SERAPHIEL_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SERAPHIEL_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `seraphiel_cli/config.py` | 1 | +streaming config defaults |
...
SERAPHIEL_STREAMING_ENABLED=true
```
