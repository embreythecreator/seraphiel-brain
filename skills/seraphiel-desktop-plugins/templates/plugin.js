/**
 * Seraphiel desktop plugin template. Save as:
 *   <seraphiel home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <seraphiel home> is ~/.seraphiel by default, or ~/.seraphiel/profiles/<name>
 * when running a named profile (`seraphiel -p <name>`). Run `seraphiel doctor` (or
 ...
 * Only these imports resolve: @seraphiel/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@seraphiel/plugin-sdk'
