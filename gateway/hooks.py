...
Hooks are discovered from ~/.seraphiel/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- Seraphiel session id
...
HOOKS_DIR = get_seraphiel_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"seraphiel_hook_{hook_name}"
