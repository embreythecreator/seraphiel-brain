...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$SERAPHIEL_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_seraphiel_dir("platforms/whatsapp/session", "whatsapp/session")
