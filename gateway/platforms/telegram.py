...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._media_batch_delay_seconds = float(os.getenv("SERAPHIEL_TELEGRAM_MEDIA_BATCH_DELAY_SECONDS", "0.8"))
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                from seraphiel_cli.commands import telegram_menu_commands
