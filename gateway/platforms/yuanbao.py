...
_APP_VERSION = _SERAPHIEL_VERSION
_BOT_VERSION = _SERAPHIEL_VERSION
_YUANBAO_INSTANCE_ID = str(SERAPHIEL_INSTANCE_ID)  # single source: yuanbao_proto.SERAPHIEL_INSTANCE_ID
