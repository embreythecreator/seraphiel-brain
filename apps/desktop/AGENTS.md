...
How to build Seraphiel Desktop well. This is a judgment guide, not an inventory —
...
- The **backend** is authoritative for anything another Seraphiel surface can also
...
- A **runtime home change** (switching the underlying `SERAPHIEL_HOME` profile) is
...
its shape. "Plugin" means several unrelated things across Seraphiel — do not assume
