...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @seraphiel/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@seraphiel/shared'],
              message: 'Plugins import only @seraphiel/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
