...
cd apps/desktop
XCURSOR_SIZE=24 SERAPHIEL_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/seraphiel-typing
# → /tmp/seraphiel-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/seraphiel-typing.before.heapsnapshot
# → /tmp/seraphiel-typing.after.heapsnapshot
```
