...
export const ZOOM_STORAGE_KEY = 'seraphiel:desktop:zoomLevel'
 ...
 * but forgot to emit 'seraphiel:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('seraphiel:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
