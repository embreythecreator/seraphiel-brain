...
// even though a fresh shell — and the Seraphiel CLI — sees it immediately. The
// desktop's SERAPHIEL_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\seraphiel. Reading
...
//       SERAPHIEL_HOME    REG_SZ    F:\Seraphiel\data
//
