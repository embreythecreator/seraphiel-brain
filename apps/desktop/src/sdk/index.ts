/**
 * @seraphiel/plugin-sdk — THE plugin language. The vscode-module model: plugin
 ...
 *    object as `window.__SERAPHIEL_PLUGIN_SDK__` and maps the import to it, so a
...
import { getLogs, getStatus } from '@/seraphiel'
...
export type { RpcEvent, StatusResponse } from '@/types/seraphiel'
