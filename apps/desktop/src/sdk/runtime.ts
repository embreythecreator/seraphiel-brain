 ...
 * plugins resolve `@seraphiel/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __SERAPHIEL_PLUGIN_SDK__: sdk,
  __SERAPHIEL_REACT__: React,
  __SERAPHIEL_REACT_JSX__: jsxRuntime,
  __SERAPHIEL_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@seraphiel/plugin-sdk': shimUrl('__SERAPHIEL_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__SERAPHIEL_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__SERAPHIEL_REACT_JSX__'),
    react: shimUrl('__SERAPHIEL_REACT__')
  }
