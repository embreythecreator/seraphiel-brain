...
const TILES_KEY = 'seraphiel.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'seraphiel.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __SERAPHIEL_LAYOUT_TREE__).
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__SERAPHIEL_SESSION_TILES__ = {
