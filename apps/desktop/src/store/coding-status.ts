...
import type { SeraphielGitWorktree, SeraphielRepoStatus } from '@/global'
...
export const $repoStatus = atom<SeraphielRepoStatus | null>(null)
...
export const $repoWorktrees = atom<SeraphielGitWorktree[]>([])
...
interface RepoStatusRefreshRequest {
  probe: (cwd: string) => Promise<SeraphielRepoStatus | null>
  seq: number
  target: string
}
