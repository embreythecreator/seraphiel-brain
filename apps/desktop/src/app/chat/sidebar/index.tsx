...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/seraphiel'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('seraphiel:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('seraphiel:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Seraphiel to
