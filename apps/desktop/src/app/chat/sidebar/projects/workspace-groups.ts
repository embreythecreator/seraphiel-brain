...
import type { ProjectInfo, SessionInfo } from '@/seraphiel'
 ...
 * repo shows its branches/worktrees even when they have no Seraphiel sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: SeraphielGitWorktree[]
): SidebarSessionGroup[] {
