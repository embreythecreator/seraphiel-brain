...
import type { SessionInfo } from '@/seraphiel'
 ...
 * e.g. `seraphiel-brain/desktop` vs `seraphiel-brain-wt-rtl/desktop`. Groups with a
...
export type WorktreeResolver = (cwd: string) => SeraphielWorktreeInfo | null | undefined
