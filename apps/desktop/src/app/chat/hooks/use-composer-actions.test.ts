...
import { type DroppedFile, extractDroppedFiles, SERAPHIEL_PATHS_MIME, partitionDroppedFiles } from './use-composer-actions'
...
describe('extractDroppedFiles', () => {
  ...
  it('emits a dropped directory as a path-only entry with isDirectory (no File to upload)', () => {
    const transfer = stubTransfer([
      { path: '/Users/jeff/projects/seraphiel', isDirectory: true }
