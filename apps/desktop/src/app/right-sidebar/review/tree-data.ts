import type { SeraphielReviewFile } from '@/global'
...
export function buildReviewFlatList(files: SeraphielReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: SeraphielReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
