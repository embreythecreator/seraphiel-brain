...
const TAKEOVER_KEY = 'seraphiel.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Seraphiel can't clear via the API — the user
 *  sees exactly what runs instead of Seraphiel silently deleting their creds. */
