...
import type { ConfigFieldSchema, SeraphielConfigRecord, ToolsetInfo } from '@/types/seraphiel'
...
export function getNested(obj: SeraphielConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: SeraphielConfigRecord, path: string, value: unknown): SeraphielConfigRecord {
...
function personalityOptions(config: SeraphielConfigRecord): string[] {
...
function commandProviderNames(config: SeraphielConfigRecord, section: 'tts' | 'stt'): string[] {
