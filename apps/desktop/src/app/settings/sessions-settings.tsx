...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/seraphiel'
...
// / Program Files), which buried any files Seraphiel wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.seraphielDesktop` is
    ...
    const settings = window.seraphielDesktop?.settings
