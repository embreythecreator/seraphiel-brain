...
import {
  getElevenLabsVoices,
  getSeraphielConfigDefaults,
  getSeraphielConfigRecord,
  getSeraphielConfigSchema,
  saveSeraphielConfig
} from '@/seraphiel'
...
export function ConfigSettings({
  ...
  const [_defaults, setDefaults] = useState<SeraphielConfigRecord | null>(null)
  ...
  useEffect(() => {
    let cancelled = false
    Promise.all([getSeraphielConfigRecord(), getSeraphielConfigDefaults(), getSeraphielConfigSchema()])
      .then(([c, d, s]) => {
        if (cancelled) {
          return
        }
