...
import type { SessionInfo, SessionMessage } from '@/types/seraphiel'
...
describe('collectArtifactsForSession', () => {
  ...
  it('resolves remote image artifact thumbnails through the desktop fs bridge', async () => {
    ...
    const path = '/Users/me/.seraphiel/skills/work-esab/references/images/manual-step03.jpeg'
    ...
    expect(api).toHaveBeenCalledWith({
      path: '/api/fs/read-data-url?path=%2FUsers%2Fme%2F.seraphiel%2Fskills%2Fwork-esab%2Freferences%2Fimages%2Fmanual-step03.jpeg'
    })
  })
})
