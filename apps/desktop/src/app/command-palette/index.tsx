...
import { getSeraphielConfigRecord, listAllProfileSessions } from '@/seraphiel'
...
// Seraphiel session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
export function CommandPalette() {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getSeraphielConfigRecord,
    enabled: open
  })
    ...
    return [
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          {
            icon: Download,
            id: 'cc-update-seraphiel',
            keywords: ['update', 'upgrade', 'seraphiel', 'version', 'system', 'restart'],
            label: cc.updateSeraphiel,
