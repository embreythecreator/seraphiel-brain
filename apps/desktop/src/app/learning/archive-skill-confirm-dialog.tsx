...
import { deleteLearningNode } from '@/seraphiel'
import { type Translations, useI18n } from '@/i18n'
import { notify } from '@/store/notifications'

export const ARCHIVE_SKILL_DESCRIPTION = 'The skill is archived and can be restored with `seraphiel curator restore`.'
