...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/seraphiel'
...
const VERSION = 3
const PREFIX = 'HML' // "Seraphiel Memory Loadout" — namespaces our codes like WoW's leading bytes.
