...
export function ContribWiring({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    window.addEventListener('seraphiel:open-keybinds', onOpenKeybinds)

    return () => window.removeEventListener('seraphiel:open-keybinds', onOpenKeybinds)
  }, [navigate])
  ...
  useEffect(() => {
    ...
    void refreshSeraphielConfig(true)
    void refreshActiveProfile()
  }, [activeGatewayProfile, refreshCurrentModel, refreshSeraphielConfig])
