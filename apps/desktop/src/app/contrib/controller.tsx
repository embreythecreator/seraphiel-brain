...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <seraphiel home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('seraphiel:open-keybinds'))
    } satisfies PaletteContribution
  }
])
...
const $logsOpen = persistentAtom('seraphiel.desktop.logsOpen', false, Codecs.bool)
