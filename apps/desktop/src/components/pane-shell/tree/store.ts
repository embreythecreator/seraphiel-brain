...
const STORAGE_KEY = 'seraphiel.desktop.layoutTree.v2'

writeKey('seraphiel.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('seraphiel.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('seraphiel.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'seraphiel.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'seraphiel.desktop.userPlacedPanes.v1'
...
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__SERAPHIEL_LAYOUT_TREE__ = {
    close: closeTreePane,
