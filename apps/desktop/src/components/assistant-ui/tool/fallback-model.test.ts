  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://seraphiel-brain.embreythecreator.com/docs' },
    ...
    expect(view.title).toBe('Failed to open seraphiel-brain.embreythecreator.com/docs')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://seraphiel-brain.embreythecreator.com/docs' },
        result: { success: true, url: 'https://seraphiel-brain.embreythecreator.com/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened seraphiel-brain.embreythecreator.com/docs')
  })
})
