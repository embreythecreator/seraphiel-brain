...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Seraphiel look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Seraphiel need to see?`,
    ...
    {
      headline: `What should ${label} Seraphiel tackle?`,
...
const WORDMARK = 'SERAPHIEL AGENT'
