...
function installDesktopBridge(partial: Partial<Window['seraphielDesktop']> = {}) {
...
afterEach(() => {
  ...
  if (initialSeraphielDesktop) {
    desktopWindow.seraphielDesktop = initialSeraphielDesktop
  } else {
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['seraphielDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['seraphielDesktop']['openExternal'] })
