...
const DESKTOP_COMMAND_META = [
  ...
  ['/profile', 'Switch the active Seraphiel profile'],
  ...
  ['/version', 'Show Seraphiel Brain version'],
...
export function isDesktopSlashCommand(command: string): boolean {
  ...
  return DESKTOP_COMMANDS.has(canonical) || !isKnownSeraphielSlashCommand(normalized)
}
