...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|seraphiel):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.seraphielDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.seraphielDesktop?.openExternal?.(href)
  }
}
