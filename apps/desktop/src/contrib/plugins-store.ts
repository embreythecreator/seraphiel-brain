 ...
 * `<seraphiel home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'seraphiel.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'seraphiel.desktop.disabledPlugins.v1'
