...
export const en: Translations = {
  ...
  boot: {
    ready: 'Seraphiel Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Seraphiel settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingSeraphielDesktop: 'Starting Seraphiel Desktop…'
    },
    errors: {
      backgroundExited: 'Seraphiel background process exited.',
      backgroundExitedDuringStartup: 'Seraphiel background process exited during startup.',
    ...
    failure: {
      title: "Seraphiel couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Seraphiel backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateSeraphiel: 'Update Seraphiel',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Seraphiel Desktop.',
    ...
    native: {
      ...
      inputBody: 'Seraphiel is waiting for your response.',
      turnDoneTitle: 'Seraphiel finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Seraphiel defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Seraphiel writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Seraphiel is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Seraphiel asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Seraphiel was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Seraphiel follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Seraphiel is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Seraphiel, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Seraphiel checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Seraphiel configuration...',
    ...
    gateway: {
      ...
      intro:
        'Seraphiel Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Seraphiel backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset SERAPHIEL_DESKTOP_REMOTE_URL and SERAPHIEL_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Seraphiel backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Seraphiel backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Seraphiel Cloud',
      cloudDesc: 'Sign in once to Seraphiel Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Seraphiel Cloud',
      cloudSignIn: 'Sign in to Seraphiel Cloud',
      cloudSignedIn: 'Signed in to Seraphiel Cloud',
      cloudNeedsSignIn: 'Sign in to Seraphiel Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Seraphiel Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Seraphiel Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Seraphiel Cloud',
      cloudSignedOutMessage: 'Cleared the Seraphiel Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /seraphiel.',
      ...
      restartingMessage: 'Seraphiel Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Seraphiel ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Seraphiel runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Seraphiel at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via seraphiel curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Seraphiel builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Seraphiel to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Seraphiel to generate pets.',
      backgroundHint: 'You can close this — Seraphiel will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Seraphiel desktop' },
    ...
    seraphielActiveSessions: (version, count) => `Seraphiel ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@seraphiel:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Seraphiel environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Seraphiel will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Seraphiel backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Seraphiel. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Seraphiel...',
    placeholderReconnecting: 'Reconnecting to Seraphiel…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Seraphiel a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Seraphiel will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Seraphiel to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Seraphiel…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Seraphiel…',
    ...
    unsupportedMessage: 'This version of Seraphiel can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Seraphiel from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Seraphiel will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Seraphiel desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Seraphiel updater takes over in its own window and reopens Seraphiel automatically when it’s done. Please don’t reopen Seraphiel yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Seraphiel reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Seraphiel reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Seraphiel needs a one-time install',
    ...
    settingUpTitle: 'Setting up Seraphiel Brain',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Seraphiel CLI or desktop instance is running. Stop any running Seraphiel instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Seraphiel Brain",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Seraphiel is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Seraphiel…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Seraphiel',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Seraphiel at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Seraphiel connects automatically',
    ...
    authorizeThere: 'Authorize Seraphiel there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Seraphiel there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Seraphiel inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Seraphiel will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Seraphiel is restarting...',
      askRestart: 'Ask Seraphiel to restart the server',
      lookingRestart: taskId => `Seraphiel is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Seraphiel is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Seraphiel finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Seraphiel could not restart the server.',
      stillWorking:
        'Seraphiel is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Seraphiel is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Seraphiel gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.seraphiel/config.yaml). Seraphiel won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Seraphiel needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Seraphiel needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Seraphiel Desktop to use Save Image.',
    restartToSaveImages: 'Restart Seraphiel Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `seraphiel gateway` running?'
    }
  },
