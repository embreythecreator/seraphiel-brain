...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteDesc:
        'Connect this desktop shell to a remote Seraphiel backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Seraphiel Desktop will reconnect using the saved settings.',
  ...
  onboarding: {
    ...
    flowSubtitles: {
      ...
      loopback: 'Opens your browser to sign in — Seraphiel connects automatically',
