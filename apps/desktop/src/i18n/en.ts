...
export const en: Translations = {
  ...
  updates: {
    ...
    applyingBody: 'The Seraphiel updater will take over in its own window and reopen Seraphiel when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Seraphiel reconnects automatically when it’s back.',
    applyingClose: 'Seraphiel will close to apply the update.',
