...
class AIAgent:
    ...
    def _ensure_db_session(self) -> None:
        ...
        if self._session_db_created or not self._session_db:
            return
        source = self.platform or os.environ.get("SERAPHIEL_SESSION_SOURCE", "cli")
        try:
        ...
        **extra_context,
        ...
        if should_start and target_session_id and hasattr(engine, "on_session_start"):
            start_context = {
                ...
                "platform": getattr(self, "platform", None) or os.environ.get("SERAPHIEL_SESSION_SOURCE", "cli"),
    ...
    def _resolved_api_call_timeout(self) -> float:
        ...
        if cfg is not None:
            return cfg
        return float(os.getenv("SERAPHIEL_API_TIMEOUT", 1800.0))
