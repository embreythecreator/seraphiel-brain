...
def worker_loop(worker_id: int, seraphiel_home: str, result_file: str) -> None:
...
def reclaimer_loop(seraphiel_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="seraphiel_mixed_stress_")
    print(f"SERAPHIEL_HOME = {home}")
