...
thinking phase.  Seraphiel's default cloud-stream stale detector
(``SERAPHIEL_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``SERAPHIEL_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
