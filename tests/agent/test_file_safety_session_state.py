...
manipulation. Seraphiel keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point SERAPHIEL_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_seraphiel_home /
    get_default_seraphiel_root) instead of monkeypatching private helpers —
    ...
    SERAPHIEL_HOME=<root>/profiles/<name> makes get_default_seraphiel_root()
