...
def test_seraphiel_meta_tolerates_non_dict():
    assert learning_graph._seraphiel_meta({"metadata": "junk"}) == {}
    assert learning_graph._seraphiel_meta({"metadata": {"seraphiel": "junk"}}) == {}
    assert learning_graph._seraphiel_meta({"metadata": {"seraphiel": {"category": "x"}}}) == {"category": "x"}
