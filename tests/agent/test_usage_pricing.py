...
def test_nous_portal_pricing_preserves_vendor_prefixed_model_ids(monkeypatch):
    ...
    assert seen["base_url"] == "https://inference-api.embreythecreator.com/v1"
...
def test_deepseek_v4_pro_pricing_entry_exists():
    ...
    in seraphiel insights because the _OFFICIAL_DOCS_PRICING table had no
...
def test_fireworks_rows_all_carry_cache_read_pricing():
    ...
    model, and Seraphiel prompt caching is active on Fireworks sessions — every
