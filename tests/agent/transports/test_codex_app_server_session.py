...
class TestServerRequestRouting:
    ...
    def test_mcp_elicitation_for_seraphiel_tools_auto_accepts(self):
        """When codex elicits on behalf of seraphiel-tools (our own callback),
