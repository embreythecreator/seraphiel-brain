...
def test_metadata_as_dict_with_seraphiel():
    """Normal case: metadata is a dict containing seraphiel keys."""
    frontmatter = {
        "metadata": {
            "seraphiel": {
...
class TestParseFrontmatterBOM:
    ...
    def test_bom_config_vars_preserved(self):
        # metadata.seraphiel.config drives secure setup-on-load; it must survive
