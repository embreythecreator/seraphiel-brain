...
old_session_id=<old>). This lets plugin engines (e.g. seraphiel-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See seraphiel-lcm#68: after Seraphiel compresses and mints a new physical session,
