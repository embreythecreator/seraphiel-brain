...
_RUNTIME = "seraphiel_cli.runtime_provider.resolve_runtime_provider"
...
class TestGenerate:
    ...
    def test_posts_to_resolved_base_url(self):
        ...
        nous_runtime = _runtime_ok(
            provider="nous", base_url="https://inference.embreythecreator.com/v1", api_key="nous-tok"
        )
        ...
        assert url == "https://inference.embreythecreator.com/v1/chat/completions"
