...
Run from the PR worktree:
    ...
    cd ~/.seraphiel/seraphiel-brain/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.seraphiel/seraphiel-brain``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.seraphiel/seraphiel-brain
PR_DIR = REPO_ROOT  # the worktree we're in
assert (MAIN_DIR / "tools" / "browser_tool.py").exists(), (
    f"MAIN_DIR={MAIN_DIR} doesn't look like a seraphiel-brain checkout"
)
...
# Isolated SERAPHIEL_HOME for the config write.
