...
class TestMem0FiltersV2:
    ...
    def test_sync_turn_uses_write_filters(self, monkeypatch):
        ...
        assert call["agent_id"] == "seraphiel"
    ...
    def test_write_filters_include_agent_id(self):
        ...
        provider._user_id = "u123"
        provider._agent_id = "seraphiel"
        assert provider._write_filters() == {"user_id": "u123", "agent_id": "seraphiel"}
...
class TestMem0Defaults:
    ...
    def test_default_user_id_seraphiel_user(self, monkeypatch, tmp_path):
        ...
        assert provider._user_id == "seraphiel-user"

    def test_default_agent_id_seraphiel(self, monkeypatch, tmp_path):
        monkeypatch.setenv("MEM0_API_KEY", "test-key")
        ...
        assert provider._agent_id == "seraphiel"
