...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and seraphiel-brain
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # seraphiel-brain (tests/skills/)
]
...
def test_cdp_default_profile_uses_seraphiel_home():
    prev = os.environ.get("SERAPHIEL_HOME")
    with tempfile.TemporaryDirectory() as d:
        os.environ["SERAPHIEL_HOME"] = d
        try:
            ...
            if prev is None:
                ...
                os.environ["SERAPHIEL_HOME"] = prev
...
def test_dotenv_env_fills_missing_creds_and_shell_wins():
    prev_home = os.environ.get("SERAPHIEL_HOME")
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        try:
            ...
            for k, v in (("SERAPHIEL_HOME", prev_home), ("BROWSERBASE_API_KEY", prev_key)):
                if v is None:
