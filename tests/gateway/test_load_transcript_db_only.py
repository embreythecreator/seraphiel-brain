...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.seraphiel/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at seraphiel_state import time, before pytest's SERAPHIEL_HOME monkeypatch
    fires — the autouse fixture's SERAPHIEL_HOME override doesn't help here.)
    """
