...
def _run_setup_feishu(
    *,
    ...
    with patch("seraphiel_cli.config.save_env_value", side_effect=mock_save), \
         patch("seraphiel_cli.config.get_env_value", side_effect=mock_get), \
         patch("seraphiel_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("seraphiel_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("seraphiel_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("seraphiel_cli.cli_output.print_header"), \
         patch("seraphiel_cli.cli_output.print_info"), \
         patch("seraphiel_cli.cli_output.print_success"), \
         patch("seraphiel_cli.cli_output.print_warning"), \
         patch("seraphiel_cli.cli_output.print_error"), \
