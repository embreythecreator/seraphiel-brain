...
def test_resolve_managed_tool_gateway_derives_vendor_origin_from_shared_domain():
    ...
    assert result.gateway_origin == "https://firecrawl-gateway.embreythecreator.com"
...
def test_resolve_managed_tool_gateway_is_disabled_without_subscription():
    with patch.dict(os.environ, {"TOOL_GATEWAY_DOMAIN": "embreythecreator.com"}, clear=False), \
