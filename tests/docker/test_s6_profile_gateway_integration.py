...
The unit tests in tests/seraphiel_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned seraphiel-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/seraphiel")
from seraphiel_cli.service_manager import S6ServiceManager
