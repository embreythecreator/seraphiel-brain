...
def test_dashboard_slot_reports_up_when_enabled(
    ...
    start_container(
        ...
        "SERAPHIEL_DASHBOARD_BASIC_AUTH_PASSWORD=test-dashboard-pw",
        cmd="sleep 120",
    )
...
def test_dashboard_oauth_gate_engages_on_non_loopback_bind(
    ...
    start_container(
        built_image, container_name,
        "SERAPHIEL_DASHBOARD=1",
        "SERAPHIEL_DASHBOARD_HOST=0.0.0.0",
        "SERAPHIEL_DASHBOARD_OAUTH_CLIENT_ID=agent:test-instance",
        cmd="sleep 120",
    )
...
def test_dashboard_insecure_env_var_no_longer_bypasses_gate(
    ...
    """``SERAPHIEL_DASHBOARD_INSECURE=1`` NO LONGER disables the auth gate
    ...
    start_container(
        ...
        "SERAPHIEL_DASHBOARD=1",
        "SERAPHIEL_DASHBOARD_HOST=0.0.0.0",
        "SERAPHIEL_DASHBOARD_INSECURE=1",
        cmd="sleep 120",
    )
