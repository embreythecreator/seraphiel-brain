"""Session <-> workspace grouping key (seraphiel_state.workspace_key).

The key is what `seraphiel sessions list --workspace` groups/filters on. It is a
...
from seraphiel_state import workspace_key
