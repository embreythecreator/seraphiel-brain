...
def test_unblock_clears_sticky_state_and_lets_block_recover(kanban_home: Path) -> None:
    """``seraphiel kanban unblock`` (or the ``kanban_unblock`` tool) is
...
# tests/seraphiel_cli/test_kanban_db.py::test_connect_migrates_legacy_db_before_optional_column_indexes
