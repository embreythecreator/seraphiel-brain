"""Tests for the ``seraphiel prompt-size`` diagnostic (issue #34667)."""
...
from seraphiel_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(seraphiel_home, memory_text="", user_text=""):
    mem_dir = seraphiel_home / "memories"
...
def _seed_skill(seraphiel_home, name, description):
    skill_dir = seraphiel_home / "skills" / "demo" / name
