...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from seraphiel_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in SERAPHIEL_OVERLAYS
        overlay = SERAPHIEL_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify seraphiel doctor recognizes Xiaomi env vars."""
