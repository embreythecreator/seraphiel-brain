"""Tests for the interactive session browser (`seraphiel sessions browse`).
...
from seraphiel_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """seraphiel sessions browse should be parseable."""
