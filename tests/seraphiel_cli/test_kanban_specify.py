"""Tests for the specifier module + `seraphiel kanban specify` CLI surface.
...
from seraphiel_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `seraphiel kanban …` argparse surface directly."""
