...
Uses a throwaway SERAPHIEL_HOME so it never touches ~/.seraphiel. No real names.
"""
...
def _fresh_home():
    """Point SERAPHIEL_HOME at a throwaway dir BEFORE importing gateway modules
    (mirror.py binds _SESSIONS_INDEX from get_seraphiel_home() at import time)."""
...
# Import AFTER SERAPHIEL_HOME is set.
...
# a different get_seraphiel_home() at import if something imported it earlier).
...
def main():
    ...
    print(f"SERAPHIEL_HOME (throwaway): {HOME}")
