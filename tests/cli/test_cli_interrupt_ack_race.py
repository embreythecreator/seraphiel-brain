...
Root cause: ``SeraphielCLI.chat()`` fires ``agent.interrupt(msg)`` from its
...
def _make_cli():
    """Build a SeraphielCLI with prompt_toolkit stubbed (same pattern as
