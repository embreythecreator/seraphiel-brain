import { Box, type ScrollBoxHandle, stringWidth, Text } from '@seraphiel/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (SERAPHIEL_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (SERAPHIEL_DEV_CREDITS), lowest priority,
