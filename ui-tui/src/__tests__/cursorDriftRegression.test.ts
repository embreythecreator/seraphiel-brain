 ...
 *
 * Symptom: in `seraphiel --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@seraphiel/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using seraphiel --tui and as i type multiline my caret at the end will often ' +
