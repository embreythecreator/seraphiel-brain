import type { UsageModelData } from '@seraphiel/shared/billing'
...
// Wire shapes now live in @seraphiel/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingCardInfo,
