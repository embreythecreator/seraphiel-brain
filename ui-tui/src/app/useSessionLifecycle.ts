...
import type { ScrollBoxHandle } from '@seraphiel/ink'
import { evictInkCaches } from '@seraphiel/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SERAPHIEL_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
