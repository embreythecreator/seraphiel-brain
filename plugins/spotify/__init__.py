...
``_check_spotify_available()`` — when the user has not run ``seraphiel auth
spotify``, the tools remain registered (so they appear in ``seraphiel
...
The Spotify auth flow (``seraphiel auth spotify``), CLI plumbing, and docs
