...
def cmd_setup(args) -> None:
    ...
    if new_shape == "single":
        ...
        seraphiel_host["pinPeerName"] = True
        print(f"  pinPeerName=true → all gateway users route to '{seraphiel_host.get('peerName', '?')}'.")
        ...
        _scrub_identity_mapping(seraphiel_host)
        seraphiel_host["pinPeerName"] = False
        ...
        if _new_prefix and not (prefix_from_root and _new_prefix == current_prefix):
            seraphiel_host["runtimePeerPrefix"] = _new_prefix
        print("  Multi-user mode: each runtime ID → own peer. Use 'seraphiel honcho status' to inspect.")
        ...
        if existing_aliases:
            seraphiel_host["userPeerAliases"] = existing_aliases
        _prefix_default = current_prefix or ""
        _new_prefix = _prompt(
