...
Single-user Seraphiel memory store plugin.
"""
...
class MemoryStore:
    ...
    def __init__(
        ...
        if db_path is None:
            ...
            db_path = str(get_seraphiel_home() / "memory_store.db")
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted SERAPHIEL_HOME (same issue as
        # state.db / kanban.db — see seraphiel_state._WAL_INCOMPAT_MARKERS).
