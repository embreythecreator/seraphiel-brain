# Seraphiel Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.seraphiel/plugins/seraphiel-achievements/state.json` (existing unlock state)
  - `~/.seraphiel/plugins/seraphiel-achievements/scan_snapshot.json` (new)
  - `~/.seraphiel/plugins/seraphiel-achievements/scan_checkpoint.json` (new)
