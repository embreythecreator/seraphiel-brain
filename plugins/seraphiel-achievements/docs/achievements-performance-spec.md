# Seraphiel Achievements Performance Spec (Post-Hackathon)

Status: Draft (no code changes yet)
Owner: seraphiel-achievements plugin
...
### `GET /api/plugins/seraphiel-achievements/achievements`
...
### `POST /api/plugins/seraphiel-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/seraphiel-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/seraphiel-achievements/overview`
...
- Persist plugin data under:
  - `~/.seraphiel/plugins/seraphiel-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.seraphiel/plugins/seraphiel-achievements/scan_checkpoint.json`
...
- `~/.seraphiel/plugins/seraphiel-achievements/`
