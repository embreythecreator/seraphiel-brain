# Seraphiel Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.seraphiel/plugins/seraphiel-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.seraphiel/plugins/seraphiel-achievements/scan_checkpoint.json`.
