...
Config: ~/.seraphiel/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.seraphiel/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_seraphiel_home()`` helper (SERAPHIEL_HOME-aware and
...
RULES_FILE = get_seraphiel_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_seraphiel_home() / "feishu_comment_pairing.json"
