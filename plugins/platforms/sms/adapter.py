...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Seraphiel gateway adapter.

    Each inbound phone number gets its own Seraphiel session (multi-tenant).
...
# static dict in seraphiel_cli/gateway.py, and the _send_sms dispatch in
