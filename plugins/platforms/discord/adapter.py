...
class DiscordAdapter(BasePlatformAdapter):
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by Seraphiel: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        try:
            ...
            try:
                seed_msg = await message.channel.send(f"\U0001f9f5 Thread created by Seraphiel: **{thread_name}**")
                thread = await seed_msg.create_thread(
                    name=thread_name,
