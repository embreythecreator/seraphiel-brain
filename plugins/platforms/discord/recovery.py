...
class DiscordRecoveryStore:
    ...
    def __init__(self, seraphiel_home: Path | None = None) -> None:
        self._lock = threading.Lock()
        self._initialized = False
        self._seraphiel_home = Path(seraphiel_home or get_seraphiel_home())

    def path(self) -> Path:
        directory = self._seraphiel_home / "gateway"
