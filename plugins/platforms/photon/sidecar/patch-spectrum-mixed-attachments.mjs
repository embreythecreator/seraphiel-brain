...
// `message.content.text` before Seraphiel can see it. We rewrite the two inbound
...
const MARKER = "Seraphiel patch: Preserve mixed text + attachment iMessage payloads";
