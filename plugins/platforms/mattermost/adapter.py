...
required — uses aiohttp which is already a Seraphiel dependency.
...
def interactive_setup() -> None:
    ...
    ``seraphiel_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Seraphiel delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # seraphiel_cli/setup.py::_setup_mattermost function.
