...
# When the user hasn't picked a reasoning effort, Seraphiel passes
...
# ON at this effort — matching the "medium (default)" that Seraphiel' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Seraphiel' effort vocabulary onto Solar's accepted set. xhigh/max/
